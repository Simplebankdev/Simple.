...
Only requiring some minor changes is simple.cpp.
...
Changes to simple.cpp
----------------------
simple.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for

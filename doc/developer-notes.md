...
SimpleCore Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as SimpleCore Core, where everyone uses
...
pay attention to for reviewers of SimpleCore Core code.

General SimpleCore Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: SimpleCore Core uses tinyformat, which is type safe. Leave them out to avoid confusion

...
This mechanism has been integrated into Bitcore-Node-SimpleCore which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/simplecoin/insight-api-simple#web-socket-api](https://github.com/simplecoin/insight-api-simple#web-socket-api) 
* API: [https://github.com/simplecoin/insight-api-simple#instantsend-transactions](https://github.com/simplecoin/insight-api-simple#instantsend-transactions) 
...
By default, the SimpleCore Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SimpleCore Core daemon:

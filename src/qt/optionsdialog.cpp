    ...
    mapper(0)
{
    ...
    /* Theme selector */
    /*ui->theme->addItem(QString("SPLB-light"), QVariant("light"));*/
    ui->theme->addItem(QString("SPLB-blue"), QVariant("drkblue"));
    /*ui->theme->addItem(QString("SPLB-Crownium"), QVariant("crownium"));*/
    ui->theme->addItem(QString("SPLB-traditional"), QVariant("trad"));

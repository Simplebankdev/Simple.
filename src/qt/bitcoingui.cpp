    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("SimpleCore Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a SimpleCore address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and simple: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About SimpleCore Core"), this);
    aboutAction->setStatusTip(tr("Show information about SimpleCore Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for SimpleCore Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your SimpleCore addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified SimpleCore addresses"));
    ...
    openAction->setStatusTip(tr("Open a simple: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the SimpleCore Core help message to get a list with possible SimpleCore Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("SimpleCore Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SimpleCore network", "", count));
}
...
{
    QString strTitle = tr("SimpleCore Core"); // default title
    ...
    // Append title to "SimpleCore Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;

    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("SimpleCore Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About SimpleCore Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  simple-qt [" + tr("command-line options") + "]                     " + "\n";
        ...
        strUsage += HelpMessageOpt("-splash", strprintf(tr("Show splash screen on startup (default: %u)").toStdString(), DEFAULT_SPLBASHSCREEN));
...
All the SimpleCore in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SPLB, 0.1 SPLB, 1 SPLB and 10 SPLB -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://simplecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://simplecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("SimpleCore Core is shutting down...") + "<br /><br />" +

...
{
    if(fLiteMode) return; // ignore all SimpleCore related functionality
...
/*
    ...
    allow endless transaction that would bloat SimpleCore and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("simple-privatesend");

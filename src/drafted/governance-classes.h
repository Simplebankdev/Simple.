 ...
 *
 *   // network
 *   CSimpleCoreNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.simple.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CSimpleCoreNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CSimpleCoreNetwork(UniValue objIn)
    {
...
// // can be under: SimpleCoreNetwork
// //   -- signature requirements : Key1(User)
// class CSimpleCoreNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == SimpleCoreNetwork);
//     // }

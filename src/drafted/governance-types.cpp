...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SimpleCoreNetwork") type = SimpleCoreNetwork;
    if(strType == "SimpleCoreNetworkVariable") type = SimpleCoreNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SimpleCoreNetwork) s = "SimpleCoreNetwork";
    if(type == SimpleCoreNetworkVariable) s = "SimpleCoreNetworkVariable";
